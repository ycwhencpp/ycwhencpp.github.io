...
!(function (e, t) {
  ...
  function l(e) {
    var t = {};
    for (var n in e)
      "webkitMovementX" !== n && "webkitMovementY" !== n && (o(e[n]) ? (t[n] = c(e[n], e)) : (t[n] = e[n]));
    return t;
  }
  function s(e) {
    function t(t) {
    ...
    function n(e) {
      for (_ = 0; _ < ee.length; _++)
        (B = ee[_]), i(B) ? S[(e ? "add" : "remove") + "EventListener"].call(S, B, N, !1) : o(B) ? (N = B) : (S = B);
    }
    function r() {
      I(A),
        (A = R(r)),
        ...
        e.running &&
          ...
          (e.now = z),
          t(e.update),
          Z && (e.retina && (e.save(), e.autoclear && e.scale(V, V)), e.autoclear && e.clear()),
          t(e.draw),
    ...
    function p(n) {
      for (
        n = d(n),
          ...
          e.dragging = !!/down|start/.test(W) || (!/up|end/.test(W) && e.dragging);
        M;
    ...
    var f,
      ...
      k = {
        ...
        augment: function (e, t) {
          return (
            (t = a(t || {}, E)), (t.element = e.canvas || e), (t.element.className += " sketch"), a(e, t, !0), s(e)
          );
        },
      },
      P = ["ms", "moz", "webkit", "o"],
